...
public class OrderStateMachine {
    ...
    private static final Map<OrderStatus, Set<OrderStatus>> ALLOWED_TRANSITIONS = Map.ofEntries(
            ...
            Map.entry(OrderStatus.PAID,                    Set.of(OrderStatus.PACKED, OrderStatus.ADMIN_CANCELLED)),
            Map.entry(OrderStatus.PACKED,                  Set.of(OrderStatus.OUT_FOR_DELIVERY, OrderStatus.ADMIN_CANCELLED)),
